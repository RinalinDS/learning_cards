...
export const TablePage: FC = () => {
  ...
  const amountOfElementsToShow = useAppSelector(state => state.packs.amountOfElementsToShow)
  const portionSizeForPages = useAppSelector(state => state.packs.portionSizeForPages)
  const portionNumber = useAppSelector(state => state.packs.portionNumber)
  ...
  const searchPack = useAppSelector<string>(state => state.packs.searchPack)
